...
demo::NormalSphereDemo::NormalSphereDemo()
{
	// Get input module 
	...
	// Create Shader
	m_Shader = std::make_unique<Shader>("res/shaders/VisualizeNormal");
	...
	std::cout << "This demo uses camera controls!" << std::endl;
	std::cout << "    WASD - Move camera horizontally on the X/Z plane." << std::endl;
	std::cout << "    E - Move camera up on the Y axis." << std::endl;
	std::cout << "    Q - Move camera down on the Y axis." << std::endl;
	std::cout << "    Left/Right/Up/Down arrow keys - Rotate camera left/right/up/down." << std::endl;
}
...
void demo::NormalSphereDemo::OnUpdate(float deltaTime)
{
...
void demo::NormalSphereDemo::OnRender()
{
